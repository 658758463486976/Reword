...
> На початковому етапі додаток не мав перекладу на понад **4 000 із 10 000** англійських слів українською.  
...
3. Встановити і **імпортувати базу в ReWord** (через налаштування).
...
В офіціала 20 категорій, в покращеному 50.   *До 20 VS 50 після*
